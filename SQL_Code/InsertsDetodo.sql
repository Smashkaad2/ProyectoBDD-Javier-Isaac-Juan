...
--Staff
insert into Staff (id_staff, numero_documento, nombre, apellido, direccion, num_telefono, fecha_nacimiento, sexo, salario_anual, username, contrasena, id_tipo_documento, clinica_id, id_equipo, cargo_id) values (1, '6512135202', 'Omar', 'Palacios', '17 Corben Plaza', '9181796271', TO_DATE('15/06/2023', 'DD/MM/YYYY'), 'F', 1254485.42, 'pstrongitharm0', 'kG9}WFrW#}R(Ax', 3, 1, 1, 1);
insert into Staff (id_staff, numero_documento, nombre, apellido, direccion, num_telefono, fecha_nacimiento, sexo, salario_anual, username, contrasena, id_tipo_documento, clinica_id, id_equipo, cargo_id) values (2, '2644174981', 'Jose', 'Gonzalez', '074 Westend Road', '4517784794', TO_DATE('14/05/2023', 'DD/MM/YYYY'), 'M', 2550252.19, 'fcolson1', 'cS1/{}Qo02`d', 3, 1, 2, 1);
insert into Staff (id_staff, numero_documento, nombre, apellido, direccion, num_telefono, fecha_nacimiento, sexo, salario_anual, username, contrasena, id_tipo_documento, clinica_id, id_equipo, cargo_id) values (3, '4283727129', 'Pedro', 'Ramirez', '84 Talmadge Point', '7587606533', TO_DATE('24/09/2023', 'DD/MM/YYYY'), 'F', 8645806.72, 'wdeboy2', 'oQ7#pDgNW>m,', 3, 1, 3, 1);
insert into Staff (id_staff, numero_documento, nombre, apellido, direccion, num_telefono, fecha_nacimiento, sexo, salario_anual, username, contrasena, id_tipo_documento, clinica_id, id_equipo, cargo_id) values (4, '3305954011', 'Maria', 'Rojas', '3 Crowley Place', '8117841261', TO_DATE('24/09/2023', 'DD/MM/YYYY'), 'F', 723165.14, 'dosheeryne3', 'rH8?5tCksBJ)l', 3, 2, 3, 2);
insert into Staff (id_staff, numero_documento, nombre, apellido, direccion, num_telefono, fecha_nacimiento, sexo, salario_anual, username, contrasena, id_tipo_documento, clinica_id, id_equipo, cargo_id) values (5, '3605954011', 'Javier', 'Wolf', '3 Crowley Place', '8117841262', TO_DATE('24/09/2023', 'DD/MM/YYYY'), 'M', 783165.14, 'kaadtrash', 'rH8?5tCkDBJ)l', 3, 2, 3, 3);
...
insert into Staff (id_staff, numero_documento, nombre, apellido, direccion, num_telefono, fecha_nacimiento, sexo, salario_anual, username, contrasena, id_tipo_documento, clinica_id, id_equipo, cargo_id) values (7, '2336612140', 'Gustavo', 'Duque', '4555 Graedel Road', '2719087559', TO_DATE('14/05/2023', 'DD/MM/YYYY'), 'F', 5163505.59, 'jgonnel6', 'jM8}5tm4,o', 3, 1, 3, 1);
insert into Staff (id_staff, numero_documento, nombre, apellido, direccion, num_telefono, fecha_nacimiento, sexo, salario_anual, username, contrasena, id_tipo_documento, clinica_id, id_equipo, cargo_id) values (8, '9759002748', 'Andres', 'Pastrana', '219 Surrey Trail', '7375133766', TO_DATE('14/05/2023', 'DD/MM/YYYY'), 'M', 8081619.40, 'adillestone7', 'bE7$dG+)<FnzEvG', 3, 2, 1, 2);
insert into Staff (id_staff, numero_documento, nombre, apellido, direccion, num_telefono, fecha_nacimiento, sexo, salario_anual, username, contrasena, id_tipo_documento, clinica_id, id_equipo, cargo_id) values (9, '6956548781', 'Roberto', 'Pumarejo', '37 Old Shore Point', '9541286894', TO_DATE('14/05/2023', 'DD/MM/YYYY'), 'F', 9178468.47, 'aendacott8', 'vV6|r))F!mx', 3, 3, 2, 1);
insert into Staff (id_staff, numero_documento, nombre, apellido, direccion, num_telefono, fecha_nacimiento, sexo, salario_anual, username, contrasena, id_tipo_documento, clinica_id, id_equipo, cargo_id) values (10, '7155228752', 'Kenny', 'Bell', '759 Grayhawk Drive', '7054450448', TO_DATE('14/05/2023', 'DD/MM/YYYY'), 'F', 3894791.03, 'tdugood9', 'aQ8+PNe)gr5\', 3, 3, 3, 3);
...
--facturaTratamientos
insert into TratamientoFactura (codigo_tratamiento_id, factura_id, estado_tratamiento, mascota_id, id_staff, fecha, hora, descripcion) values (1, 10, 2, 1, 1, TO_DATE('03/04/2023','DD/MM/YYYY'), 14.38, 'Basectomia');
insert into TratamientoFactura (codigo_tratamiento_id, factura_id, estado_tratamiento, mascota_id, id_staff, fecha, hora, descripcion) values (2, 8, 2, 2, 2, TO_DATE('12/10/2023','DD/MM/YYYY'), 14.03, 'Extirpacion de Berruga no benigna');
insert into TratamientoFactura (codigo_tratamiento_id, factura_id, estado_tratamiento, mascota_id, id_staff, fecha, hora, descripcion) values (3, 9, 3, 3, 3, TO_DATE('02/05/2023','DD/MM/YYYY'), 22.43, 'Parto');
insert into TratamientoFactura (codigo_tratamiento_id, factura_id, estado_tratamiento, mascota_id, id_staff, fecha, hora, descripcion) values (4, 3, 3, 4, 4, TO_DATE('24/05/2023','DD/MM/YYYY'), 6.16, 'Cirugia corazon abierto');
insert into TratamientoFactura (codigo_tratamiento_id, factura_id, estado_tratamiento, mascota_id, id_staff, fecha, hora, descripcion) values (5, 2, 4, 5, 5, TO_DATE('02/12/2022','DD/MM/YYYY'), 12.50, 'Terapia de choque');
insert into TratamientoFactura (codigo_tratamiento_id, factura_id, estado_tratamiento, mascota_id, id_staff, fecha, hora, descripcion) values (6, 1, 4, 6, 6, TO_DATE('27/09/2023','DD/MM/YYYY'), 0.01, 'Terapia de rehabilitacion para adiccion al suenno');
insert into TratamientoFactura (codigo_tratamiento_id, factura_id, estado_tratamiento, mascota_id, id_staff, fecha, hora, descripcion) values (7, 4, 2, 7, 7, TO_DATE('17/04/2023','DD/MM/YYYY'), 6.54, 'Incubadora');
insert into TratamientoFactura (codigo_tratamiento_id, factura_id, estado_tratamiento, mascota_id, id_staff, fecha, hora, descripcion) values (8, 5, 3, 8, 8, TO_DATE('14/09/2023','DD/MM/YYYY'), 12.57, 'Anestesia especial');
insert into TratamientoFactura (codigo_tratamiento_id, factura_id, estado_tratamiento, mascota_id, id_staff, fecha, hora, descripcion) values (9, 6, 4, 9, 9, TO_DATE('21/09/2023','DD/MM/YYYY'), 9.50, 'Bebida especial para trastornos');
insert into TratamientoFactura (codigo_tratamiento_id, factura_id, estado_tratamiento, mascota_id, id_staff, fecha, hora, descripcion) values (10, 7, 2, 10, 10, TO_DATE('27/05/2023','DD/MM/YYYY'), 22.32, 'Fisio terapia');
